    ...
    render() {
        return (
            <div className='blog3' >
                ...
                <div className-='blog3-sub'>
                    <p>So for a long time many people who know me have said that I have "Killer Cupcakes". (Don't worry, they aren't called that because they kill people <span role="img">😆</span>) <br />
                        ...
                        Just so you all know I did not make this recipe up. I got it from one of my mum's Betty Crocker's Cookbook. (If there is some copyright issues with this post let me know.) <br />
                ...
                <br />
                <div>
                    <h5> Silver White Cake </h5> 
                    <list>2 1/4 cups all-purpose flour (do not use self rising flour) <br />
                        1 2/3 cups sugar <br />
                        ...
                        5 egg whites</list>
                    <br />
                    <p>Heat oven to 350 degrees. Line 24 medium cupcake cups with paper baking cups.<br /> Beat all ingredients except egg whites on low speed, scraping bowl constantly, 30 seconds.
                Beat on high speed, scraping bowl occasionally, 2 minutes. Beat in egg whites on high speed, scraping bowl occasionally, 2 minutes. <br />
                        Pour into cupcake liners. (I use a 1/4 cup measure cookie scoop to get everything all even) <br />
                ...
                <br />
                    ...
                    <br />
                        ...
                        <h5>Cream Cheese Frosting </h5><br />
