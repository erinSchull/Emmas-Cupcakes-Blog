    ...
    render() {
        return (
            <div className='hello-blog' >
                ...
                <p className='blog1-body' >Hey! So I'm Emma. So I decided I wanted to start a blog but I haven't quite decided on what to write about.
                ...
                <p className='blog1-body'>So now I will talk about real stuff. This is my first post so... what actually goes in a blog post? I don't really know... I'll figure it out eventually.</p>
                <p className='blog1-body'>But this is all I've got for now. Hopefully future posts will be better.</p>
